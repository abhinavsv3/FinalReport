...
\item Forced editor layout which is a tool to dynamically add nodes and edges after the graph visualization has taken place. D3 has a forced editor sample which could be useful for further study.
\end{enumerate}
